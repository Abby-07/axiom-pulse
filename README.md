Here is the technical documentation for the project, formatted as a standard README.md file.
...
Environment: The simulation logic is client-side, requiring no separate Node.js server process.

Linting: The build pipeline enforces ESLint rules. Ensure all unused variables are removed before pushing to production.
